...
class OpenAIRealtimeConnector {
    ...
    _sendSetup() {
        ...
        this._send({
            ...
            session: {
                ...
                input_audio_transcription: { model: 'whisper-1', language: (typeof getLangConfig === 'function') ? getLangConfig().target.id : 'es' },
                turn_detection: {
                    type:               'server_vad',
                    threshold:           0.5,
    ...
    async saveRecording(sessionId) {
        ...
        // Аудіо завжди шлємо на той самий origin — CORS не блокує
