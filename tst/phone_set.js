const AI_EXERCISE_CONFIG = {
    ...
    exercises: {
        ...
        'describe': {
            ...
            scenePromptInstruction: (level) => `Generate a vivid scene description for an English learning illustration. Level: ${level}. Requirements: simple everyday scene with 2-3 details (people, place, action, time of day or weather), 20-30 words, in English. Return ONLY the scene description, no questions, no extra text. Example: "A young woman sitting on a park bench reading a book on a sunny afternoon, with pigeons nearby"`,
