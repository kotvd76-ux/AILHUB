const AI_EXERCISE_CONFIG = {
    ...
    levelProfiles: {
        A1: { pace: 'дуже повільно з паузами', lexicon: 'лише базові дієслова (бути, мати, йти, хотіти), числа, кольори, прості іменники', syntax: '1 речення 4-6 слів', grammar: 'лише теперішній час, стверджувальні речення' },
        A2: { pace: 'повільно, чітко',         lexicon: 'базова побутова лексика, часовживані дієслова',                                    syntax: '1-2 короткі речення', grammar: 'теперішній + минулий простий, прості питання' },
        B1: { pace: 'помірний темп',           lexicon: 'розмовна лексика середнього рівня',                                                syntax: '2-3 речення',          grammar: 'всі основні часи, умовний спосіб просто' },
        B2: { pace: 'близько до природного',   lexicon: 'вільна розмовна лексика, ідіоми',                                                  syntax: '3-4 речення',          grammar: 'складні форми, умовний та наказовий вільно' },
        C1: { pace: 'природний темп носія',    lexicon: 'багата лексика, ідіоматичні вирази, мовні кліше',                                  syntax: '4-5 речень',           grammar: 'весь граматичний спектр, стилістичні варіації' },
    },
