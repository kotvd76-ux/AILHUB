...
const GRAMMAR_CONFIG = {
  ...
  exercises: [
    ...
    // ── 01 ДІЄСЛІВНЕ ДОМІНО ────────────────────────────────────
    {
      ...
      nouns: ['механік', 'художник', 'журналіст', 'студент', 'пожежник'],
      verbs: ['ремонтує', 'малює', 'розповідає', 'вчиться', 'гасить'],
    ...
    // ── 02 КОНТРАСТ ФОРМ (мовозалежна) ────────────────────────
    {
      ...
      nouns: ['лікар', 'менеджер', 'сусіди', 'студент', 'партнери'],
      verbs: ['сперечаються', 'домовляються', 'прощаються', 'вибачаються', 'скаржаться'],
    ...
    // ── 03 FILL-IN-THE-BLANK ───────────────────────────────────
    {
      ...
      nouns: ['пілот', 'кухар', 'охоронець', 'вчений', 'митник'],
      verbs: ['керує', 'готує', 'охороняє', 'досліджує', 'перевіряє'],
    ...
    // ── 04 КОНТЕКСТНИЙ ВИБІР (3 варіанти, мовозалежна) ────────
    {
      ...
      nouns: ['актор', 'лікар', 'спортсмен', 'пілот', 'студент'],
      verbs: ['виходить на сцену', 'завершує зміну', 'фінішує', 'злітає', 'захищає роботу'],
    ...
    // ── 05 ЗНАЙДИ ПОМИЛКУ ──────────────────────────────────────
    {
      ...
      nouns: ['меню', 'розклад', 'оголошення', 'рецепт', 'реклама'],
      verbs: ['складають', 'оновлюють', 'перевіряють', 'виправляють', 'публікують'],
    ...
    // ── 06 TAP-ORDER TRANSFORM ───────────────────────────────
    {
      ...
      level: 'A1–C1',
      nouns: ['кандидат', 'відвідувач', 'пасажир', 'пацієнт', 'учень'],
      verbs: ['нервується', 'замовляє', 'чекає', 'записується', 'запитує'],
      focuses: [
    ...
    // ── 07 СЛОВНИК ───────────────────────────────────────────
    {
      ...
      label: 'Словник',
      level: 'A1–C1',
      nouns: ['мандрівник', 'менеджер', 'покупець', 'пацієнт', 'студент'],
      verbs: ['планує', 'презентує', 'обирає', 'консультується', 'вивчає'],
      focuses: [
