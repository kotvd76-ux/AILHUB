    ...
    // ── 05 ЗНАЙДИ ПОМИЛКУ ──────────────────────────────────────
    {
      ...
      aiPrompt(level) {
        ...
        return (
          ...
          'КРИТИЧНО: речення words[] У ВИХІДНОМУ ВИГЛЯДІ (з помилковим словом на місці errorIdx) ПОВИННО мати очевидну граматичну помилку. НЕ бери вже правильну фразу і не вигадуй неіснуючу помилку — спочатку склади правильне речення, потім свідомо зіпсуй ОДНЕ слово.\n' +
